...
public class Campo {
	...
	Campo (int linha, int coluna) {
		this.linha = linha; 
		this.coluna = coluna;
// o atributo de instancia receberá o que foi colocado no construtor		

	}
	
	// isso é um método
	// esse método está implicitamente definido como default...
	//... de forma que eles só está visivel dentro deste package
